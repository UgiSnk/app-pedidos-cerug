...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_elements(self, page_count):
        ...
        if self._pageNumber > 1:
            ...
            self.drawString(left_margin, 752, "COMPONENT NEW HOUSE")
        ...
        self.setFont("Helvetica", 8)
        self.setFillColor(gray_text)
        self.drawString(left_margin, 38, "Component New House © 2026  |  Desarrollado con Alviss")
...
def build_pdf(filename):
    ...
    intro_p1 = (
        "Este manual describe la operación y gestión de la plataforma digital de <b>Component New House</b>. "
    ...
    story.append(Paragraph(
        "La aplicación cliente está disponible en la URL oficial <b>https://pedidos-component.web.app</b>. "
    ...
    story.append(Paragraph("• <b>Lucas Ugolini:</b><br/>"
                           "<font face='Courier' color='#1A202C'>https://pedidos-component.web.app/?vendedorID=vendedor_lucas</font>", bullet_style))
    story.append(Paragraph("• <b>Component Vendedor:</b><br/>"
                           "<font face='Courier' color='#1A202C'>https://pedidos-component.web.app/?vendedorID=vendedor_component_nuevo</font>", bullet_style))
    ...
    story.append(Paragraph(
        "El cliente interactúa con una interfaz premium inspirada en la web oficial de Component:",
        body_style
    ))
    story.append(Paragraph("1. <b>Pantalla de Inicio:</b> Muestra el banner principal de la marca, la barra del vendedor asignado y el panel de categorías con imágenes desaturadas sepia y doble borde blanco.", bullet_style))
    ...
    story.append(code_block(
        ...
        "----------------------------------------\n"
        "Cliente: Pablo Gómez\n"
        "Vendedor Asignado: Lucas Ugolini\n"
        "----------------------------------------\n"
    ...
    story.append(Paragraph(
        "El portal administrativo web está diseñado para computadoras y tablets, disponible en la dirección "
        "<b>https://pedidos-component.web.app/admin/</b>. Utiliza Firebase Auth para el control de acceso corporativo.",
        body_style
    ))
    ...
    story.append(Paragraph("• <b>Usuario Administrador:</b> <font face='Courier'>lucasugolinik@gmail.com</font>", bullet_style))
    story.append(Paragraph("• <b>Contraseña de Seguridad:</b> <font face='Courier'>Luro3186</font>", bullet_style))
    ...
    story.append(Paragraph("• <b>Número de Teléfono:</b> Debe ingresarse con el código de país y código de área, sin espacios ni símbolos (ej. <b>5491173564074</b> para un número celular de Argentina). De lo contrario, los redireccionamientos de WhatsApp del cliente fallarán.", bullet_style))
    ...
    story.append(Paragraph("2. <b>Copiado de Enlace:</b> El portal genera un link con el dominio de producción y el token (ej. <font size='8'>https://pedidos-component.web.app/?vendedorID=lucas&amp;token=xyz</font>) listo para enviárselo al cliente.", bullet_style))
...
if __name__ == '__main__':
    output_path = r"C:\Users\Ugi Desk\.gemini\antigravity\scratch\app-pedidos-flutterflow\Manual_Usuario_Component.pdf"
